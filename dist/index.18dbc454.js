...
async function getData() {
    try {
        ...
        document.getElementById("courseProgression").addEventListener("click", ()=>{
            sortData("progression", data);
        });
    } catch (error) {
        tableBody.innerHTML = "misslyckades att n\xe5 data, f\xf6rs\xf6k igen senare";
    }
}
...
function searchInput(e, data) {
    ...
    const filteredData = data.filter((course)=>{
        ...
        return code.includes(e) || coursename.includes(e) || progression.includes(e);
    });
...
},{}]},["iqNlW","1SICI"], "1SICI", "parcelRequire34b3")
