...
async function getData() {
  try {
    ...
    document.getElementById("courseCode").addEventListener("click", () => { sortData("code", data); });
    document.getElementById("courseName").addEventListener("click", () => { sortData("coursename",data); });
    document.getElementById("courseProgression").addEventListener("click", () => { sortData("progression",data); });
...
function searchInput(e, data) {
  ...
  const filteredData = data.filter((course) => {
    ...
    return (
      code.includes(e) ||
      coursename.includes(e) ||
      progression.includes(e)
    );
  });
